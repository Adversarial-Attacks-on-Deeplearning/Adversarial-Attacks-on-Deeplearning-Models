...
\subsection{Video and Physical-World Robustness}
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Sparsity optimization}: Limiting perturbations to 5\% pixel/text modification using reinforcement learning \cite{sparsity_opt}.
    \item \textbf{Ethical benchmarking}: Curating unified evaluation standards for adversarial robustness across vision, NLP, and ASR tasks \cite{ethical_benchmarking}.
\end{itemize}
